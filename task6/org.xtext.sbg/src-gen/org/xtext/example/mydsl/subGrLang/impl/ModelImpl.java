 ...
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.subGrLang.impl.ModelImpl#getPersons <em>Persons</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelImpl extends MinimalEObjectImpl.Container implements Model
{
  ...
  {
    return SubGrLangPackage.Literals.MODEL;
  }
  ...
  public EList<Person> getPersons()
  {
    if (persons == null)
    {
      persons = new EObjectContainmentEList<Person>(Person.class, this, SubGrLangPackage.MODEL__PERSONS);
    }
    return persons;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SubGrLangPackage.MODEL__PERSONS:
