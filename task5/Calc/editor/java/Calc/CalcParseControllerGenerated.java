...
public class CalcParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("Calc");
  ...
  { 
    CalcParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = CalcParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = CalcParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(CalcParseControllerGenerated.class);
    }
  ...
  { 
    return CalcParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
